...
public class FriendActivity extends Activity{
	...
	private void loadUI() {
		...
		img1 = (ImageView)findViewById(R.id.fimg_21);
		img2 = (ImageView)findViewById(R.id.fimg_22);
		img3 = (ImageView)findViewById(R.id.fimg_23);
		img4 = (ImageView)findViewById(R.id.fimg_24);
		img5 = (ImageView)findViewById(R.id.fimg_25);
		img6 = (ImageView)findViewById(R.id.fimg31);
		img7 = (ImageView)findViewById(R.id.fimg32);
		img8 = (ImageView)findViewById(R.id.fimg33);
		img9 = (ImageView)findViewById(R.id.fimg34);
		img10 = (ImageView)findViewById(R.id.fimg35);
		...
		img16 = (ImageView)findViewById(R.id.fimg41);
		img17 = (ImageView)findViewById(R.id.fimg42);
		img18 = (ImageView)findViewById(R.id.fimg43);
		img19 = (ImageView)findViewById(R.id.fimg44);
		img20 = (ImageView)findViewById(R.id.fimg45);
	}
